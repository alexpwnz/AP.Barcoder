...
namespace AP.Barcoder.Utils
{
    internal struct GFPoly
    {
        ...
        public GFPoly(GaloisField galoisField, int[] coefficients)
        {
            ...
            if (Coefficients.Length == 0) Coefficients = new[] {0};
        }

        public static GFPoly Zero(GaloisField galoisField)
        {
            return new GFPoly(galoisField, new[] {0});
        }
        ...
        public GFPoly AddOrSubtract(GFPoly other)
        {
            ...
            if (smallCoefficients.Length > largeCoefficients.Length) largeCoefficients = smallCoefficients;
